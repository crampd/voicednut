...
export const DASHBOARD_ACTION_CONTRACTS = {
  ...
  CALLBACK_TASKS_LIST: 'callback_tasks.list',
  REVIEW_CASES_LIST: 'review_cases.list',
...
export const DASHBOARD_MODULE_ACTION_CONTRACTS = {
  ops: [
    ...
    DASHBOARD_ACTION_CONTRACTS.CALLBACK_TASKS_LIST,
    DASHBOARD_ACTION_CONTRACTS.REVIEW_CASES_LIST,
